<?php
	...
	$query = "SELECT * FROM tb09_providers WHERE tb09_usuario = '".$usuario."' AND tb09_senha = '".$senhaHash."'";
	...
	if($resultadoselect->num_rows>0) { 
    	while ($linha = $resultadoselect->fetch_assoc()){  
			...
			$loginbd = $linha["tb09_usuario"];
			$senhabd = $linha["tb09_senha"];
			$ativo = $linha["tb09_ativo"];
